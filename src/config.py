...
WINDOW_SIZE = 5                 # Reduced from 15 for faster response
TEMPORAL_WINDOW = 5             # Alias for WINDOW_SIZE (used in web app)
QUARREL_THRESHOLD = 0.60        # Lowered from 0.75 since Audio is disabled
CAMERA_SOURCE = 0          # 0 for webcam, or video file path ('/Users/adityakulkarni/Downloads/MajorProject/quarrel-detection-project/videoplayback.mp4')
...
CNN_WEIGHT = 0.5                # Weight for CNN prediction

MOTION_WEIGHT = 0.5             # Weight for motion analysis (increased to focus on behavior)
AUDIO_WEIGHT = 0.0              # Weight for audio analysis (DISABLED)

# Audio Configuration
ENABLE_AUDIO = False            # Disable audio to prevent segmentation faults on some systems
